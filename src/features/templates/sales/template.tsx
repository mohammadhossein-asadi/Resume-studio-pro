...
export function SalesTemplate({ resume }: TemplateProps) {
  ...
  return (
    <div dir={dir} className="h-full p-8" style={{ fontFamily: '"Inter", sans-serif' }}>
      ...
      <div className="border-b-4 pb-4 mb-6" style={{ borderColor: settings.primaryColor }}>
        <h1 className="text-2xl font-bold mb-1" style={{ color: settings.primaryColor }}>
